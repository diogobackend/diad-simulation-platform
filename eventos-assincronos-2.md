...
```mermaid
%%{init: {"theme":"base","themeVariables":{"background":"#071525","primaryColor":"#0B1E33","primaryTextColor":"#F8FAFC","primaryBorderColor":"#2563EB","lineColor":"#60A5FA","secondaryColor":"#102A46","tertiaryColor":"#0B1E33","fontFamily":"Inter, Arial"}}}%%
flowchart LR
    ...
    classDef main fill:#0B1E33,stroke:#2563EB,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
...
```mermaid
%%{init: {"theme":"base","themeVariables":{"background":"#071525","primaryColor":"#0B1E33","primaryTextColor":"#F8FAFC","primaryBorderColor":"#2563EB","lineColor":"#60A5FA","fontFamily":"Inter, Arial"}}}%%
flowchart LR
    K[◉ Kafka] --> E[⚡ Evento de domínio]
    R[▤ RabbitMQ] --> C[➤ Comando assíncrono]

    classDef broker fill:#102A46,stroke:#38BDF8,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
    classDef flow fill:#0B1E33,stroke:#2563EB,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
    class K,R broker;
    class E,C flow;
```
...
flowchart TB
    ...
    classDef event fill:#0B1E33,stroke:#2563EB,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
    classDef command fill:#102A46,stroke:#38BDF8,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
...
flowchart LR
    ...
    classDef node fill:#0B1E33,stroke:#2563EB,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
    class P,X,Q,C node;
```
...
flowchart LR
    ...
    classDef main fill:#0B1E33,stroke:#2563EB,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
    classDef alert fill:#2A1420,stroke:#F43F5E,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
...
flowchart TB
    ...
    classDef main fill:#0B1E33,stroke:#2563EB,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
    classDef decision fill:#102A46,stroke:#38BDF8,stroke-width:2px,color:#F8FAFC;
    class M,A,P,R main;
    class C decision;
```
...
flowchart LR
    ...
    classDef service fill:#0B1E33,stroke:#2563EB,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
    classDef topic fill:#0B1E33,stroke:#38BDF8,stroke-width:2px,color:#F8FAFC;
...
flowchart TB
    ...
    classDef service fill:#0B1E33,stroke:#2563EB,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
    classDef queue fill:#0B1E33,stroke:#38BDF8,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
...
flowchart TB
    ...
    classDef service fill:#0B1E33,stroke:#2563EB,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
    classDef kafka fill:#0B1E33,stroke:#2563EB,stroke-width:2px,color:#F8FAFC;
    classDef rabbit fill:#0B1E33,stroke:#38BDF8,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
...
flowchart LR
    ...
    classDef core fill:#0B1E33,stroke:#2563EB,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
    classDef blue fill:#102A46,stroke:#38BDF8,stroke-width:2px,color:#F8FAFC,rx:12,ry:12;
