...
```mermaid
%%{init: {"theme":"base","themeVariables":{"background":"#08111f","primaryColor":"#111827","primaryTextColor":"#ffffff","primaryBorderColor":"#7c3aed","lineColor":"#8b5cf6","secondaryColor":"#0f172a","tertiaryColor":"#111827","fontFamily":"Inter, Arial"}}}%%
flowchart LR
    A[Application] --> B[Scoring]
    B --> C[Performance]
    C --> D[Ranking]
    D --> E[Answer Key]
    E --> F[Result]
    ...
    classDef main fill:#111827,stroke:#8b5cf6,stroke-width:2px,color:#fff,rx:12,ry:12;
...
```mermaid
%%{init: {"theme":"base","themeVariables":{"background":"#08111f","primaryColor":"#111827","primaryTextColor":"#ffffff","primaryBorderColor":"#7c3aed","lineColor":"#8b5cf6","fontFamily":"Inter, Arial"}}}%%
flowchart LR
    K[Kafka] --> E[Evento de domínio]
    R[RabbitMQ] --> C[Comando assíncrono]

    classDef broker fill:#111827,stroke:#3b82f6,stroke-width:2px,color:#fff,rx:12,ry:12;
    classDef flow fill:#111827,stroke:#8b5cf6,stroke-width:2px,color:#fff,rx:12,ry:12;
    class K,R broker;
    class E,C flow;
```
...
flowchart TB
    ...
    classDef event fill:#111827,stroke:#8b5cf6,stroke-width:2px,color:#fff,rx:12,ry:12;
    classDef command fill:#111827,stroke:#3b82f6,stroke-width:2px,color:#fff,rx:12,ry:12;
...
flowchart LR
    ...
    classDef node fill:#111827,stroke:#8b5cf6,stroke-width:2px,color:#fff,rx:12,ry:12;
    class P,X,Q,C node;
```
...
flowchart LR
    ...
    classDef main fill:#111827,stroke:#8b5cf6,stroke-width:2px,color:#fff,rx:12,ry:12;
    classDef alert fill:#111827,stroke:#ef4444,stroke-width:2px,color:#fff,rx:12,ry:12;
...
flowchart TB
    ...
    classDef main fill:#111827,stroke:#8b5cf6,stroke-width:2px,color:#fff,rx:12,ry:12;
    classDef decision fill:#111827,stroke:#3b82f6,stroke-width:2px,color:#fff;
    class M,A,P,R main;
    class C decision;
```
...
flowchart LR
    ...
    classDef service fill:#111827,stroke:#8b5cf6,stroke-width:2px,color:#fff,rx:12,ry:12;
    classDef topic fill:#0f172a,stroke:#3b82f6,stroke-width:2px,color:#fff;
...
flowchart TB
    ...
    classDef service fill:#111827,stroke:#8b5cf6,stroke-width:2px,color:#fff,rx:12,ry:12;
    classDef queue fill:#0f172a,stroke:#3b82f6,stroke-width:2px,color:#fff,rx:12,ry:12;
...
flowchart TB
    ...
    classDef service fill:#111827,stroke:#8b5cf6,stroke-width:2px,color:#fff,rx:12,ry:12;
    classDef kafka fill:#0f172a,stroke:#8b5cf6,stroke-width:2px,color:#fff;
    classDef rabbit fill:#0f172a,stroke:#3b82f6,stroke-width:2px,color:#fff,rx:12,ry:12;
...
flowchart LR
    ...
    classDef core fill:#111827,stroke:#8b5cf6,stroke-width:2px,color:#fff,rx:12,ry:12;
    classDef blue fill:#111827,stroke:#3b82f6,stroke-width:2px,color:#fff,rx:12,ry:12;
