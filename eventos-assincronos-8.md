...
<div style="background:#07182D; padding:28px; border-radius:14px; overflow:auto; margin:16px 0;">
...
%%{init: {
  ...
  "themeCSS": ".mermaid, .mermaid svg, svg { background-color: #07182D !important; } .mermaid svg { background: #07182D !important; } .edgeLabel rect { fill: #07182D !important; }"
}}%%
flowchart LR
