...
> **Padrão visual dos diagramas:** fundo integral **azul-marinho escuro `#0A2342`**, mantendo tonalidade azul claramente visível; cards em azul-marinho médio, contornos azul vivo e textos claros.
...
%%{init: {
  ...
  "themeVariables": {
    ...
    "edgeLabelBackground": "#0A2342",
    "fontFamily": "Inter, Arial"
  },
  "themeCSS": ".mermaid { background: #0A2342 !important; } svg { background: #0A2342 !important; } .edgeLabel rect { fill: #0A2342 !important; } .labelBkg { background: #0A2342 !important; }"
}}%%
flowchart LR
